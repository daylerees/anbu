...
<head>
    ...
    <style>
        ...
        .method-tag-post {
            background-color: #e5c73c;
        }

        .method-tag-put,
        .method-tag-patch {
            background-color: #3a99fa;
        }
...
<body>
    <header>
        ...
        <?php $date = new Carbon\Carbon($date); ?>
        <span class="request"><span class="request-time">{{ $date->format('d/m/y H:i:s') }}</span><a href="{{ url('/anbu') }}" class="request-reset" title="Back to latest."><i class="fa fa-reply"></i></a></span>
